...
distancia1=((pow(matriz1[j][1]-prom4_2,2))+(pow(matriz1[j][0]-prom4_1,2))+(pow(matriz1[j][2]-prom4_3,2)));
  ...
  if(matriz3[k][1]==1){
    ...
    Serial.println(String(matriz3[k][0])+String(" , ")+String(matriz3[k][1])); }
    for (int q=0;q<48;q++){
...
for(;c5<48;c5++){ 
 ...
 Serial.println(String("ETIQUETA1 ")+String(etiqueta1));
 Serial.println(String("ETIQUETA2 ")+String(etiqueta2));
  Serial.println(String("ETIQUETA3 ")+String(etiqueta3));
Serial.println(String("ETIQUETA4 ")+String(etiqueta4));
  Serial.println(String("ETIQUETA5 ")+String(etiqueta5)); 
  etiqueta6=etiqueta1;
